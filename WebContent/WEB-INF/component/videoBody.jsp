        ...
        <div class="row tm-mb-90 tm-gallery">
        	<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                ...
                <figure class="effect-ming tm-video-item">
                    <img src="${pageContext.request.contextPath}/asset/img/img-03.jpg" alt="Image" class="img-fluid">
                ...
                <div class="d-flex flex-wrap justify-content-between tm-text-gray">
                    ...
                    <span class="mt-2">9,906 views</span>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <h4>title</h4>
                <figure class="effect-ming tm-video-item">
                    <img src="${pageContext.request.contextPath}/asset/img/img-04.jpg" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Plants</h2>
                        <a href="${pageContext.request.contextPath}/asset/img/photo-detail.html">View more</a>
                    </figcaption>                    
                </figure>
                <div class="d-flex flex-wrap justify-content-between tm-text-gray">
                    ...
                    <span class="tm-text-gray-light mt-2 ">14 Oct 2020</span>
                    <span class="mt-2">16,100 views</span>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <h4>title</h4>
